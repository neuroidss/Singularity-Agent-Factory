...
export const DEMO_WORKFLOW: AIToolCall[] = [
    ...
    { name: 'Define KiCad Component', arguments: { componentReference: 'J_XIAO_1', componentDescription: 'XIAO Header', componentValue: 'XIAO_HEADER', footprintIdentifier: 'Connector_PinHeader_2.54mm:PinHeader_1x07_P2.54mm_Vertical_SMD_Pin1Left', numberOfPins: 7, side: 'top' } },
    { name: 'Define KiCad Component', arguments: { componentReference: 'J_XIAO_2', componentDescription: 'XIAO Header', componentValue: 'XIAO_HEADER', footprintIdentifier: 'Connector_PinHeader_2.54mm:PinHeader_1x07_P2.54mm_Vertical_SMD_Pin1Left', numberOfPins: 7, side: 'top' } },
    ...
    { name: 'Set Simulation Heuristics', arguments: { componentSpacing: 200.0, netLengthWeight: 0.00, boardEdgeConstraint: 2.0, settlingSpeed: 0.99, proximityStrength: 10.0, symmetryStrength: 10.0, alignmentStrength: 10.0, circularStrength: 10.0, symmetricalPairStrength: 20.0, absolutePositionStrength: 10.0, fixedRotationStrength: 50.0, symmetryRotationStrength: 10.0, circularRotationStrength: 10.0 } },

    // --- Logical Layout Rules instead of absolute placement ---
    { name: 'Add Circular Constraint', arguments: { componentsJSON: '["J1","J2","J3","J4","J5","J6","J7","J8","J9","J10"]', radius: 13, centerX: 0, centerY: 0 } },
    ...
    { name: 'Add Symmetry Constraint', arguments: { axis: 'vertical', pairsJSON: '[["J_XIAO_1", "J_XIAO_2"], ["U2", "U3"], ["C5", "C7"], ["C6", "C8"], ["C3", "C4"]]' } },
