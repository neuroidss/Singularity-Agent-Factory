...
export const DEMO_WORKFLOW: AIToolCall[] = [
    ...
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'GND', pins: ["J10-1", "U1-13", "U1-25", "U1-28", "C1-1", "C2-1", "C3-2", "C4-2", "U2-2", "C5-2", "C6-2", "C7-2", "C8-2", "J_XIAO_2-1", "X1-2"] } },
    ...
    { name: 'Define KiCad Net', arguments: { projectName, netName: '5V', pins: ["C6-1", "C8-1", "J_XIAO_2-2"] } },
    ...
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'SCLK', pins: ["U1-19", "J_XIAO_1-5"] } },
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'DOUT', pins: ["U1-20", "J_XIAO_1-6"] } },
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'DIN', pins: ["U1-21", "J_XIAO_1-7"] } },
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'XTAL1/CLKIN', pins: ["U1-23", "X1-1"] } },
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'LDO_IN', pins: ["U2-1", "U3-1"] } },
    { name: 'Define KiCad Net', arguments: { projectName, netName: 'LDO_EN', pins: ["U2-3", "U3-3"] } },
